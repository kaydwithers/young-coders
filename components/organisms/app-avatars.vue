  ...
  .mw9.center.ph3.ph4-ns.pv5.pv6-ns
    ...
    .db.flex-ns
      .w-100.w-25-ns.ph4.tc
        ...
        app-paragraph(size='5', text='Kruti Patel')
        app-paragraph(size='4', text='Founder')
      .w-100.w-25-ns.ph4.tc
        ...
        app-paragraph(size='4', text='Lead Workshop Manager and Web Developer')
      .w-100.w-25-ns.ph4.tc
        ...
        app-paragraph(size='4', text='Lead Workshop Manager')
      .w-100.w-25-ns.ph4.tc
        ...
        app-paragraph(size='4', text='Editor-in-Chief')
      .w-100.w-25-ns.ph4.tc
        img.ba.br-100.bw3.b--black-20.mb4(src='http://res.cloudinary.com/dvjpaoffl/image/upload/q_auto/q_80/v1499262182/avatar-2_j5lg7c.jpg')
      ...
      .w-100.w-25-ns.ph4.tc
        ...
        app-paragraph(size='4', text='Web Developer')
      .w-100.w-25-ns.ph4.tc
        img.ba.br-100.bw3.b--black-20.mb4(src='http://res.cloudinary.com/dvjpaoffl/image/upload/q_auto/q_80/v1499262182/avatar-2_j5lg7c.jpg')
        app-paragraph(size='5', text='Dolly Desai')
        app-paragraph(size='4', text='Event Organizer')
      .w-100.w-25-ns.ph4.tc
        img.ba.br-100.bw3.b--black-20.mb4(src='http://res.cloudinary.com/dvjpaoffl/image/upload/q_auto/q_80/v1499262182/avatar-2_j5lg7c.jpg')
        app-paragraph(size='5', text='Raffi Martins')
        app-paragraph(size='4', text='Art Director and Social Media Manager')
</template>
