<template>
  <article class="pa4">
    ...
    >
    <p class="f6  mb3">{{ ( new Date(post.fields.publishDate)).toDateString() }}</p>
    <h4 class="f4  mb3  ttu"><nuxt-link :to="{ name: 'blog-slug', params: { slug: post.fields.slug }}" class="title">{{ post.fields.title }}</nuxt-link></h4>
    <p class="f5  mb3  lh-copy">{{ post.fields.description }}</p>
